...
func (m *mockGadgetManager) StartGadget(ctx context.Context, name, image string, params map[string]string) (string, error) {
	if m.startError != nil {
		return "", m.startError
	}
...
func TestInspektorGadgetHandler(t *testing.T) {
	...
	t.Run("invalid action", func(t *testing.T) {
		...
		if err == nil {
			...
			expectedErr := fmt.Sprintf("invalid action: invalid_action, expected one of %v", getValidGadgetActions())
